...
from tools.goal_registry import goal_event_flight_invoice, goal_find_contractors
...
async def get_conversation_history():
    ...
    try:
        ...
        if description.status in [
            ...
            print(f"Workflow is in {description.status} state. Returning empty history.")
            return []
...
async def send_prompt(prompt: str):
    ...
    combined_input = CombinedInput(
        ...
        agent_goal=goal_find_contractors,
    )
