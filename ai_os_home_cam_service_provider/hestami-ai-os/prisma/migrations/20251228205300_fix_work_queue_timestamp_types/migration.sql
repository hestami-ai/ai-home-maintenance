-- =============================================================================
-- Fix Staff Work Queue Function Timestamp Types
-- =============================================================================
-- The tables use timestamp(3) WITHOUT time zone but the function declared
-- TIMESTAMPTZ (timestamp WITH time zone). This fixes the type mismatch.
-- =============================================================================
