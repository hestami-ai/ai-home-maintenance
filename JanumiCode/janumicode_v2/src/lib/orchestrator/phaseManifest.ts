...
export const PHASES: readonly PhaseEntry[] = [
  ...
  {
    id: 'cross_cutting_bootstrap',
    displayCode: '0.5',
    displayName: 'Cross-Cutting Bootstrap',
    description: 'Bootstrap shared cross-cutting state before the linear pipeline begins.',
  },
  {
    id: 'intent_capture',
    displayCode: '1',
  ...
  },
  {
    ...
    description: 'Test case generation (skeleton + saturation), test plan synthesis, fixtures, gate.',
  },
  {
...
export const SUB_PHASES: readonly SubPhaseEntry[] = [
  // ── Phase 0 — workspace_init ────────────────────────────────────────
  {
    ...
    description: 'Classify workspace state and project type.',
    agentRole: 'orchestrator',
  },
  {
    id: 'workspace_ingestion',
    parentPhase: 'workspace_init',
    group: 'workspace_classification',
    displayName: 'Workspace Ingestion',
    description: 'Ingest workspace files into the governed stream.',
    agentRole: 'orchestrator',
  },
  {
    id: 'active_constraint_extraction',
    parentPhase: 'workspace_init',
    group: 'active_constraints',
    displayName: 'Active Constraint Extraction',
    description: 'Extract active constraints from ingested artifacts.',
    agentRole: 'orchestrator',
  },
  {
    id: 'active_constraint_enrichment',
    parentPhase: 'workspace_init',
    group: 'active_constraints',
    displayName: 'Active Constraint Enrichment',
    description: 'Enrich constraints with sources, authority levels.',
    agentRole: 'orchestrator',
  },
  {
  ...
  // ── Phase 0.5 — cross_cutting_bootstrap ─────────────────────────────
  {
    id: 'cross_cutting_bootstrap_init',
    parentPhase: 'cross_cutting_bootstrap',
    displayName: 'Cross-Cutting Bootstrap Init',
    description: 'Initialize cross-cutting subsystems (memory, narrative, etc.).',
    agentRole: null,
  },
  ...
  },
  {
    ...
    parentPhase: 'intent_capture',
    group: 'domains_personas_bloom',
    displayName: 'Business Domains Bloom',
    description: 'Bloom business domains (Phase 1 step 5a).',
    agentRole: 'domain_interpreter',
  },
  {
    id: 'intent_domain_bloom',
    parentPhase: 'intent_capture',
    group: 'domains_personas_bloom',
    displayName: 'Intent Domain Bloom',
    description: 'Bloom personas / intent domains (Phase 1 step 5b).',
    agentRole: 'domain_interpreter',
  },
  {
    ...
    description: 'Initial bloom of user journeys.',
    agentRole: 'domain_interpreter',
  },
  {
    id: 'user_journey_decomposition',
    parentPhase: 'intent_capture',
    group: 'user_journey',
    displayName: 'User Journey Decomposition',
    description: 'Recursive decomposition of user journeys into steps.',
    agentRole: 'domain_interpreter',
  },
  {
    id: 'system_workflow_bloom',
    parentPhase: 'intent_capture',
    group: 'system_workflow',
    displayName: 'System Workflow Bloom',
    description: 'Initial bloom of system workflows.',
    agentRole: 'domain_interpreter',
  },
  {
    id: 'system_workflow_decomposition',
    parentPhase: 'intent_capture',
    group: 'system_workflow',
    displayName: 'System Workflow Decomposition',
    description: 'Recursive decomposition of system workflows.',
    agentRole: 'domain_interpreter',
  },
  {
  ...
  {
    id: 'intent_statement_synthesis',
    parentPhase: 'intent_capture',
    displayName: 'Intent Statement Synthesis',
    description: 'Synthesize the canonical intent statement.',
    agentRole: 'domain_interpreter',
  },
  {
  ...
  // ── Phase 10 — commit ───────────────────────────────────────────────
  {
    id: 'commit_prep',
    parentPhase: 'commit',
    displayName: 'Commit Prep',
    description: 'Prepare commit artifacts (Phase 10.1).',
    agentRole: null,
  },
  {
    id: 'commit_execute',
    parentPhase: 'commit',
    displayName: 'Commit Execute',
    description: 'Execute the commit (Phase 10.2).',
    agentRole: null,
  },
  {
    id: 'commit_finalize',
    parentPhase: 'commit',
    displayName: 'Commit Finalize',
