...
const TEMPLATE_PATHS = [
  'prompts/phases/phase_05_technical_specification/data_model_skeleton/data_models.system.md',
  'prompts/phases/phase_05_technical_specification/api_definitions/api_definitions.system.md',
  'prompts/phases/phase_05_technical_specification/error_handling/error_handling_strategies.system.md',
  'prompts/phases/phase_05_technical_specification/configuration_parameters/configuration_parameters.system.md',
];
