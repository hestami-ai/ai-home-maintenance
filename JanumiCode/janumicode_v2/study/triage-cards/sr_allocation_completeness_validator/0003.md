# Triage card — sr_allocation_completeness_validator · finding 3/9

**Finding record id:** `b2774d1c-d57c-4591-8256-f46792dce22d`
...
- **severity:** HIGH
- **type:** uncovered_sr
- **summary:** SR 'SR-001' is not allocated to any component
...
System requirement 'SR-001' appears in the input prompt but no component's allocation includes it.

### Recommendation

Allocate 'SR-001' to the component(s) responsible for delivering that system requirement.
