# Triage card — source_item_enumeration_completeness · finding 5/10

**Finding record id:** `998a481a-7eb1-496e-ab96-28f3a9b7df75`
**Sub-phase:** `system_requirements`
**Produced at:** 2026-05-12T06:24:16.370Z
**Reviewed agent role:** `?`
...
- **summary:** Output field 'system_requirements' is absent; source item 'NFR-017' silently dropped
...
Source context contained id 'NFR-017' but output field 'system_requirements' is missing entirely.

### Recommendation

Ensure 'system_requirements' is populated with an entry referencing 'NFR-017'.
