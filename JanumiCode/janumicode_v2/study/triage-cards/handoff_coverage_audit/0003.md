# Triage card — handoff_coverage_audit · finding 3/8

**Finding record id:** `0a9d93c1-8ee3-449f-92d0-ad1f7af6fb6e`
...
- **summary:** The journey for handling redirect errors is not covered by any NFR.
- **location:** UJ-ERROR-RECOVERY
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

No NFR traces_to UJ-ERROR-RECOVERY.

### Recommendation

Add NFR(s) tracing to UJ-ERROR-RECOVERY, potentially covering US-005.
