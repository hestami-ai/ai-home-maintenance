# Triage card — pass_scope_discipline · finding 5/10

**Finding record id:** `25c6ee34-1764-4f95-915d-8189d5383d9c`
**Sub-phase:** `fr_bloom_skeleton`
**Produced at:** 2026-05-12T02:45:07.642Z
**Reviewed agent role:** `?`
...
- **location:** US-012 / acceptance_criteria / measurable_condition
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

The inclusion of 'in <1s' is a measurable non-functional requirement (NFR) threshold, belonging to Pass 2 enrichment.
