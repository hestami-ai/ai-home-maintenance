# Triage card — pass_scope_discipline · finding 6/10

**Finding record id:** `e5ad9d80-3f40-4846-98ec-2aa1734b12fa`
**Sub-phase:** `fr_bloom_skeleton`
**Produced at:** 2026-05-12T02:45:07.643Z
**Reviewed agent role:** `?`
...
- **location:** US-013 / acceptance_criteria / measurable_condition
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

The inclusion of 'within 50ms' is a measurable non-functional requirement (NFR) threshold, belonging to Pass 2 enrichment.
