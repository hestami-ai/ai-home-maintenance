# Triage card — extraction_id_traceability · finding 4/10

**Finding record id:** `a12c9ade-25d5-4930-9ee6-f4302c72805b`
**Sub-phase:** `compliance_retention_discovery`
**Produced at:** 2026-05-12T01:07:28.911Z
**Reviewed agent role:** `?`
...
- **severity:** HIGH
- **type:** malformed_id
- **summary:** Malformed id 'COMP-GDPR-JURIS'
- **location:** $.compliance_extracted_items[0].id
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

Id 'COMP-GDPR-JURIS' does not match PREFIX-NNN pattern.
