# Triage card — extraction_id_traceability · finding 6/10

**Finding record id:** `327e1ae0-ac60-44bd-94f7-4985d03eb167`
**Sub-phase:** `vv_requirements_discovery`
**Produced at:** 2026-05-12T01:14:17.639Z
**Reviewed agent role:** `?`
...
- **severity:** HIGH
- **type:** malformed_id
- **summary:** Malformed id 'VV-RTO-SLO'
- **location:** $.vvRequirements[2].id
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

Id 'VV-RTO-SLO' does not match PREFIX-NNN pattern.
