# Triage card — extraction_id_traceability · finding 5/10

**Finding record id:** `ba953508-2d3b-413e-b76d-de46dc67e55b`
**Sub-phase:** `compliance_retention_discovery`
**Produced at:** 2026-05-12T01:07:28.915Z
**Reviewed agent role:** `?`
...
- **severity:** HIGH
- **type:** malformed_id
- **summary:** Malformed id 'COMP-GDPR-DELETION'
- **location:** $.compliance_extracted_items[2].id
- **target_field:** (not provided)
- **target_identifier:** (not provided)

### Detail

Id 'COMP-GDPR-DELETION' does not match PREFIX-NNN pattern.
