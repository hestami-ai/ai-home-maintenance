...
[(opens in a new window)](https://ghuntley.com/loop/)  
...
We tried the “one big [AGENTS.md⁠](https://agents.md/)  
[(opens in a new window)](https://agents.md/)  
...
Design documentation is catalogued and indexed, including verification status and a set of core beliefs that define agent-first operating principles. [Architecture documentation⁠](https://matklad.github.io/2021/02/06/ARCHITECTURE.md.html)  
[(opens in a new window)](https://matklad.github.io/2021/02/06/ARCHITECTURE.md.html)  
...
Plans are treated as first-class artifacts. Ephemeral lightweight plans are used for small changes, while complex work is captured in [execution plans⁠](https://cookbook.openai.com/articles/codex_exec_plans)  
[(opens in a new window)](https://cookbook.openai.com/articles/codex_exec_plans)  
...
[(opens in a new window)](https://lexi-lambda.github.io/blog/2019/11/05/parse-don-t-validate/)  
, but are not prescriptive on how that happens (the model seems to like Zod, but we didn’t specify that specific library).  
Agents are most effective in environments with [strict boundaries and predictable structure⁠](https://bits.logic.inc/p/ai-is-forcing-us-to-write-good-code)  
[(opens in a new window)](https://bits.logic.inc/p/ai-is-forcing-us-to-write-good-code)  
