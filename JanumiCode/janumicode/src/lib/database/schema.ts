...
CREATE TABLE IF NOT EXISTS intake_conversations (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    dialogue_id TEXT NOT NULL,
    sub_state TEXT NOT NULL CHECK(sub_state IN ('GATHERING','DISCUSSING','SYNTHESIZING','AWAITING_APPROVAL','INTENT_DISCOVERY','PRODUCT_REVIEW','PROPOSING','CLARIFYING','PROPOSING_DOMAINS','PROPOSING_JOURNEYS','PROPOSING_ENTITIES','PROPOSING_INTEGRATIONS')) DEFAULT 'DISCUSSING',
