...
const TARGET_ALIASES: Record<string, NavigationTarget> = {
	...
	'proposing domains': { majorPhase: Phase.INTAKE, subPhase: IntakeSubState.PROPOSING_BUSINESS_DOMAINS, subPhaseOwner: 'INTAKE' },
	'domains': { majorPhase: Phase.INTAKE, subPhase: IntakeSubState.PROPOSING_BUSINESS_DOMAINS, subPhaseOwner: 'INTAKE' },
