...
/** ObjectEnvelope.objectType (all Professional Work Objects); AssurancePolicyDefinition.applicableObjectTypes — RPH-DOC-002 §4 (17 runtime) + 4 authoring objects (RPH-DOC-010) */
