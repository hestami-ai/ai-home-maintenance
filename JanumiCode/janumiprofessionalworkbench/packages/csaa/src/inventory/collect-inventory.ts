		...
		unknowns: [
			...
			},
			{
				...
				statement:
					...
					' The aggregate unexecuted preliminary report-command population includes command-dispatch-topology, guard-classification-overlay, and command-event-contract-overlay.'
			},
			{
				provenance: canonicalProvenance(
