...
## Hygiene passes (2026-07-24, post-regression — ministerial record in REG-005 Section A)
§11 preamble corrected (register-shadow closures reflected; the old '(neither is a register entry)' parenthetical removed) by the regression hygiene pass; version advanced 1.1.0 → 1.1.1 by the micro-hygiene pass to enumerate that correction. No semantic change; mechanical completion of REG-D-014 S-11.
