...
| The `commitState`/edit-append sites (`DeletePwa`, `EditPwa`, `EditPwuType`, `RemovePwuType`, `AppendConversationEntries`) | Not status advances; their re-issue harm (duplicate edit / owning-PWA `semanticVersion` bump / duplicated conversation entries) needs the reader-precondition/predicate variant, not a `fromStates` set — DS-001 critique B4 ground | F-6; DWP-08 |
