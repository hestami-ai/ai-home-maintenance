...
| Subject ID | `37a40c8e7bf344c3786d815fc89fc2187a0981aae0bb55628d8fe0ed426387ef` | Domain-separated file-manifest, configuration, schema, perimeter, and exclusion-policy identity |
| File-manifest digest | `f7249190f92a2fa961d88e37fe9a413415c312be0cccf0e7ce43d5b2c54df5c1` | `766 selected files` |
| Configuration digest | `dc155c6e8f8c66514b587814a6013efcdcf1c43b004902705d7664f7f762c70e` | Selected files classified as configuration |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `CONFIGURATION` | 57 | 57 | 0 | 57 | 0 | `subject.selectedFiles#artifactClass=CONFIGURATION`, `subject.excludedArtifacts[*].physicalFileCount` |
...
| `OTHER` | UNKNOWN | 129 | UNKNOWN | 129 | 0 | `subject.selectedFiles#artifactClass=OTHER`, `subject.excludedArtifacts[*].physicalFileCount` |
| `SCRIPT` | 13 | 13 | 0 | 13 | 0 | `subject.selectedFiles#artifactClass=SCRIPT`, `subject.excludedArtifacts[*].physicalFileCount` |
| `SOURCE` | 211 | 211 | 0 | 211 | 0 | `subject.selectedFiles#artifactClass=SOURCE`, `subject.excludedArtifacts[*].physicalFileCount` |
| `TEST` | 298 | 298 | 0 | 298 | 0 | `subject.selectedFiles#artifactClass=TEST`, `subject.excludedArtifacts[*].physicalFileCount` |
...
| `PACKAGE` | `@janumipwb/csaa` | `packages/csaa` | `true` | 2 | 2 | `DECLARED` | `package.json#workspaces`, `packages/csaa/package.json` |
...
| `packages/csaa/tsconfig.build.json` | `COMPLETE` | `COMPILER_ROOTS` | `./tsconfig.json` | `ABSENT` | `ABSENT` | `NONE` | 51 | 0 | `NONE` | `NONE` | `RUN: 0` | `packages/csaa/tsconfig.build.json`, `packages/csaa/package.json`, `packages/csaa/tsconfig.build.json`, `packages/csaa/tsconfig.json`, `packages/typescript-config/base.json`, `packages/typescript-config/package.json` |
| `packages/csaa/tsconfig.json` | `COMPLETE` | `COMPILER_ROOTS` | `@janumipwb/typescript-config/base.json` | `src` | `ABSENT` | `NONE` | 73 | 0 | `NONE` | `NONE` | `RUN: 0` | `packages/csaa/tsconfig.json`, `packages/csaa/package.json`, `packages/csaa/tsconfig.json`, `packages/typescript-config/base.json`, `packages/typescript-config/package.json` |
...
| `verif/guard-enforcement-ledger.ts` | `1aeab4efde15cdc99602c81ce4e09f5c7889870bc4cfdf8f4fc5d2247b9095e4` | `RUNTIME_GUARD` | `FILESYSTEM_OR_TEXT` | Repository files, exports, or runtime events selected by verif/guard-enforcement-ledger.ts at execution time. | `verif/guard-enforcement-ledger.test.ts`, `verif/recomposition-ungoverned.test.ts` | `NONE` | `RETAIN_DELEGATED` | `verif/guard-enforcement-ledger.ts` |
...
| `dependency-graph` | `PARTIAL` | `typescript` | The first bounded DWP-004 increment projects every compiler-observed module occurrence into a validated TypeScript module-dependency graph with distinct occurrence relations, explicit non-source targets, provenance, limitations, and reconciled forward/reverse indexes. Manifest dependencies, resolved component instances, inferred or observed runtime dependencies, depcruise comparison, calls, flow, and cross-Program composition are not implemented by this increment. | `packages/csaa/src/contracts/graph.ts`, `packages/csaa/src/graph/build-module-dependency-graph.ts`, `packages/csaa/src/graph/ids.ts`, `packages/csaa/src/graph/module-dependency-content.ts`, `packages/csaa/src/graph/module-dependency-input.ts`, `packages/csaa/src/graph/validate-graph.ts`, `packages/csaa/src/providers/typescript/extract-symbols.ts`, `packages/csaa/src/semantic/raw-semantic-model.ts`, `packages/csaa/src/semantic/normalize-semantic-snapshot.ts`, `packages/csaa/src/semantic/validate-snapshot.ts` |
| `call-graph` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `code-property-graph` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `control-flow` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `data-flow` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `runtime-traces` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `security-query` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `test-coverage-ingestion` | `UNIMPLEMENTED` | `—` | Not implemented by the current bounded DWP-004 module-dependency graph increment; no call, control-flow, data-flow, code-property, security, coverage, or runtime graph support is inferred from semantic snapshots, the module graph, or installed tools. | `packages/csaa/src/contracts/inventory.ts` |
...
- TypeScript compiler roots from DWP-002 are consumed by current DWP-003 frozen Program construction and TS_PROJECT/TS_SYNTAX/TS_SYMBOL/TS_TYPE extraction. The first bounded DWP-004 increment implements only the validated compiler module-dependency projection; cross-Program semantic reconciliation, depcruise comparison, call/flow/state-machine graphs, and composed graph projections remain UNIMPLEMENTED. Provenance: `packages/csaa/src/contracts/semantic.ts`, `packages/csaa/src/providers/typescript/compiler-input-journal.ts`, `packages/csaa/src/providers/typescript/extract-static-raw.ts`, `packages/csaa/src/providers/typescript/frozen-compiler-host.ts`, `packages/csaa/src/semantic/build-static-semantic-snapshot.ts`, `packages/csaa/src/providers/typescript/extract-symbols.ts`, `packages/csaa/src/semantic/raw-semantic-model.ts`, `packages/csaa/src/semantic/normalize-semantic-snapshot.ts`, `packages/csaa/src/semantic/validate-snapshot.ts`, `packages/csaa/src/providers/typescript/extract-types.ts`, `packages/csaa/src/contracts/graph.ts`, `packages/csaa/src/graph/build-module-dependency-graph.ts`, `packages/csaa/src/graph/ids.ts`, `packages/csaa/src/graph/module-dependency-content.ts`, `packages/csaa/src/graph/module-dependency-input.ts`, `packages/csaa/src/graph/validate-graph.ts`, `capabilities#dependency-graph`, `capabilities#symbol-table`, `capabilities#typescript-ast`, `capabilities#type-graph`.
