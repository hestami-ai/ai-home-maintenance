...
| Subject ID | `174edba2232b04b07c0aa632a788a12daacfd67a147d2f150c17a7b09a4fb552` | Domain-separated file-manifest, configuration, schema, perimeter, and exclusion-policy identity |
| File-manifest digest | `f14bf0338ed0b2bb571e6d9e23084f328a46c19c94f96b19c667f17bd27a4314` | `747 selected files` |
| Configuration digest | `1ebed35bd6490f44d8b2eb67516fdfe370fdcb2d914c1a6265ddbd381c7119e4` | Selected files classified as configuration |
...
| `SOURCE` | 197 | 197 | 0 | 197 | 0 | `subject.selectedFiles#artifactClass=SOURCE`, `subject.excludedArtifacts[*].physicalFileCount` |
| `TEST` | 293 | 293 | 0 | 293 | 0 | `subject.selectedFiles#artifactClass=TEST`, `subject.excludedArtifacts[*].physicalFileCount` |
...
| `packages/csaa/tsconfig.build.json` | `COMPLETE` | `COMPILER_ROOTS` | `./tsconfig.json` | `ABSENT` | `ABSENT` | `NONE` | 37 | 0 | `NONE` | `NONE` | `RUN: 0` | `packages/csaa/tsconfig.build.json`, `packages/csaa/package.json`, `packages/csaa/tsconfig.build.json`, `packages/csaa/tsconfig.json`, `packages/typescript-config/base.json`, `packages/typescript-config/package.json` |
| `packages/csaa/tsconfig.json` | `COMPLETE` | `COMPILER_ROOTS` | `@janumipwb/typescript-config/base.json` | `src` | `ABSENT` | `NONE` | 54 | 0 | `NONE` | `NONE` | `RUN: 0` | `packages/csaa/tsconfig.json`, `packages/csaa/package.json`, `packages/csaa/tsconfig.json`, `packages/typescript-config/base.json`, `packages/typescript-config/package.json` |
...
| `call-graph` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `code-property-graph` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `control-flow` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `data-flow` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `runtime-traces` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `security-query` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `symbol-table` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `test-coverage-ingestion` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `type-graph` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
| `typescript-ast` | `UNIMPLEMENTED` | `—` | Scheduled after the generated-inventory increment; no support is inferred from installed tools. | `packages/csaa/src/contracts/inventory.ts` |
...
- TypeScript compiler roots are resolved by DWP-002; semantic Program construction remains deferred to DWP-003. Provenance: `typescriptProjects[*].resolvedRootState`.
