...
import { runArrowCommandCensusCommand } from '../packages/csaa/src/application/run-arrow-command-census-command.js';
...
try {
	...
	process.exitCode = await runArrowCommandCensusCommand(request, {
		repositoryRoot: ROOT,
