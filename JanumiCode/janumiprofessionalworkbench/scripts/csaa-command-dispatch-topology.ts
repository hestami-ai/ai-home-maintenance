...
import { runCommandDispatchTopologyCommand } from '../packages/csaa/src/application/run-command-dispatch-topology-command.js';
...
try {
	...
	process.exitCode = await runCommandDispatchTopologyCommand(request, {
		repositoryRoot: ROOT,
