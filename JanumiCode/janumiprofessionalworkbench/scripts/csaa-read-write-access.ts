...
import { runReadWriteAccessCommand } from '../packages/csaa/src/application/run-read-write-access-command.js';
...
try {
	...
	process.exitCode = runReadWriteAccessCommand(request, {
		repositoryRoot: ROOT,
