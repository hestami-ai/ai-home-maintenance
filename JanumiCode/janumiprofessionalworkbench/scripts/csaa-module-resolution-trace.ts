...
import { runModuleResolutionTraceCommand } from '../packages/csaa/src/application/run-module-resolution-trace-command.js';
...
try {
	...
	process.exitCode = runModuleResolutionTraceCommand(request, {
		repositoryRoot: ROOT,
