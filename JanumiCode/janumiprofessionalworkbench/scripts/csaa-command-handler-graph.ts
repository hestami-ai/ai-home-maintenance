...
import { runCommandHandlerGraphCommand } from '../packages/csaa/src/application/run-command-handler-graph-command.js';
...
try {
	...
	process.exitCode = await runCommandHandlerGraphCommand(request, {
		repositoryRoot: ROOT,
