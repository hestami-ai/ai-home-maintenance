...
import { runModuleDependencyCommand } from '../packages/csaa/src/application/run-module-dependency-command.js';
...
try {
	...
	process.exitCode = runModuleDependencyCommand(request, {
		repositoryRoot: ROOT,
