...
import { runGuardClassificationOverlayCommand } from '../packages/csaa/src/application/run-guard-classification-overlay-command.js';
...
try {
	...
	process.exitCode = await runGuardClassificationOverlayCommand(request, {
		repositoryRoot: ROOT,
