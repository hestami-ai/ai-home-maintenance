...
import { runLogicalGraphCompositionCommand } from '../packages/csaa/src/application/run-logical-graph-composition-command.js';
...
try {
	...
	process.exitCode = await runLogicalGraphCompositionCommand(request, {
		repositoryRoot: ROOT,
