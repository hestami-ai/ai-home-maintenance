...
import { createStructuralSccProgressJsonlWriter } from '../packages/csaa/src/application/structural-scc-progress-jsonl.js';
...
try {
	...
	const progressWriter = createStructuralSccProgressJsonlWriter({
	...
	process.exitCode = structuralSccReportExitCode(outcome);
} catch (error) {
