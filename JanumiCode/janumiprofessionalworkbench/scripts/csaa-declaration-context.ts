...
import { runDeclarationContextCommand } from '../packages/csaa/src/application/run-declaration-context-command.js';
...
try {
	...
	process.exitCode = runDeclarationContextCommand(request, {
		repositoryRoot: ROOT,
