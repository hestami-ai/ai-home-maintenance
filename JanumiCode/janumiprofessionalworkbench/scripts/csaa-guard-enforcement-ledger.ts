...
import { runGuardEnforcementLedgerCommand } from '../packages/csaa/src/application/run-guard-enforcement-ledger-command.js';
...
try {
	...
	process.exitCode = await runGuardEnforcementLedgerCommand(request, {
		repositoryRoot: ROOT,
