...
import { runCommandEventContractOverlayCommand } from '../packages/csaa/src/application/run-command-event-contract-overlay-command.js';
...
try {
	...
	process.exitCode = await runCommandEventContractOverlayCommand(request, {
		repositoryRoot: ROOT,
